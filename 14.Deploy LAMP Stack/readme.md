...
kubectl create secret generic database --from-literal=MYSQL_ROOT_PASSWORD=ach123 --from-literal=MYSQL_DATABASE=kodekloud --from-literal=MYSQL_USER=ach --from-literal=MYSQL_PASSWORD=ach --from-literal=MYSQL_HOST=mysql-service
